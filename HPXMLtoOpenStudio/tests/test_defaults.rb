...
class HPXMLtoOpenStudioDefaultsTest < Minitest::Test
  ...
  def test_roofs
    ...
    XMLHelper.write_file(hpxml.to_doc, @tmp_hpxml_path)
    _default_hpxml, default_hpxml_bldg = _test_measure()
    _test_default_roof_values(default_hpxml_bldg.roofs[0], HPXML::RoofMaterialAsphaltShingles, 0.70, HPXML::ColorWhite, true, 0.90, true, 1, HPXML::InteriorFinishPlaster, 0.5, 45)
