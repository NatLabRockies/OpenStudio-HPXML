...
class HPXMLtoOpenStudioValidationTest < Minitest::Test
  ...
  def test_schema_schematron_error_messages
    ...
    all_expected_errors = { 'boiler-invalid-afue' => ['Expected AnnualHeatingEfficiency[Units="AFUE"]/Value to be less than or equal to 1'],
                            ...
                            'hvac-research-features-timestep-ten-mins' => ['Expected /HPXML/SoftwareInfo/extension/SimulationControl/Timestep to be 1',
                                                                           'Expected Timestep to be 1'],
                            'hvac-research-features-timestep-missing' => ['Expected /HPXML/SoftwareInfo/extension/SimulationControl/Timestep to be 1',
                                                                          'Expected Timestep to be 1'],
                            ...
                            'missing-duct-area' => ['Expected FractionDuctArea or DuctSurfaceArea [context: /HPXML/Building/BuildingDetails/Systems/HVAC/HVACDistribution/DistributionSystemType/AirDistribution/Ducts[DuctLocation], id: "Ducts2"]'],
                            ...
                            'multifamily-common-space-extra-inputs' => ['Expected only SystemIdentifier to be specified when sameas attribute used',
                                                                        ...
                                                                        'Expected only SystemIdentifier to be specified when sameas attribute used',
                                                                        'Expected only SystemIdentifier to be specified when sameas attribute used'],
                            'multifamily-common-space-whole-sfa-or-mf-building-sim-false' => ['Expected ExteriorAdjacentTo [context: /HPXML/Building/BuildingDetails/Enclosure/RimJoists/RimJoist[not(SystemIdentifier/@sameas and /HPXML/SoftwareInfo/extension/WholeSFAorMFBuildingSimulation[text()="true"])], id: "RimJoist2_2"]',
                                                                                              'Expected ExteriorAdjacentTo [context: /HPXML/Building/BuildingDetails/Enclosure/Walls/Wall[not(SystemIdentifier/@sameas and /HPXML/SoftwareInfo/extension/WholeSFAorMFBuildingSimulation[text()="true"])], id: "Wall2_3"]',
                                                                                              'Expected ExteriorAdjacentTo [context: /HPXML/Building/BuildingDetails/Enclosure/FoundationWalls/FoundationWall[not(SystemIdentifier/@sameas and /HPXML/SoftwareInfo/extension/WholeSFAorMFBuildingSimulation[text()="true"])], id: "FoundationWall2_2"]',
                                                                                              'Expected ExteriorAdjacentTo [context: /HPXML/Building/BuildingDetails/Enclosure/Floors/Floor[not(SystemIdentifier/@sameas and /HPXML/SoftwareInfo/extension/WholeSFAorMFBuildingSimulation[text()="true"])], id: "Floor1_1"]'],
                            ...
                            'panel-without-load-type' => ['Expected LoadType [context: /HPXML/Building/BuildingDetails/Systems/ElectricPanels/ElectricPanel/ServiceFeeders/ServiceFeeder, id: "ServiceFeeder1"]'],
  ...
  def test_ruby_warning_messages
    ...
    all_expected_warnings.each_with_index do |(warning_case, expected_warnings), i|
      ...
      when 'multiple-inverter-efficiencies'
        hpxml, _hpxml_bldg = _create_hpxml('base-pv-inverters.xml')
      ...
      when 'schedule-file-and-setpoints'
        hpxml, hpxml_bldg = _create_hpxml('base.xml')
        hpxml_bldg.water_heating_systems[0].temperature = 125
