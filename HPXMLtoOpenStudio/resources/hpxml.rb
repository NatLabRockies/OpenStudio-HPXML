...
class HPXML < Object
  ...
  class Header < BaseElement
    ...
    ATTRS = [:xml_type,                                    # [String] XMLTransactionHeaderInformation/XMLType
             ...
             :hvac_blower_off_delay,                       # [Double] SoftwareInfo/extension/SimulationControl/AdvancedResearchFeatures/HVACBlowerOffDelay (sec)
    ...
    def to_doc(hpxml_doc)
      ...
      if (not @timestep.nil?) || (not @sim_begin_month.nil?) || (not @sim_begin_day.nil?) || (not @sim_end_month.nil?) || (not @sim_end_day.nil?) || (not @sim_calendar_year.nil?) || (not @temperature_capacitance_multiplier.nil?) || (not @hvac_onoff_thermostat_deadband.nil?) || (not @hvac_blower_off_delay.nil?) || (not @heat_pump_backup_heating_capacity_increment.nil?) || (not @ground_to_air_heat_pump_model_type.nil?)
        extension = XMLHelper.create_elements_as_needed(software_info, ['extension'])
        ...
        if (not @temperature_capacitance_multiplier.nil?) || (not @hvac_onoff_thermostat_deadband.nil?) || (not @hvac_blower_off_delay.nil?) || (not @heat_pump_backup_heating_capacity_increment.nil?) || (not @ground_to_air_heat_pump_model_type.nil?)
          ...
          XMLHelper.add_element(advanced_research_features, 'HVACBlowerOffDelay', @hvac_blower_off_delay, :float, @hvac_blower_off_delay_isdefaulted) unless @hvac_blower_off_delay.nil?
    ...
    def from_doc(hpxml)
      ...
      @hvac_blower_off_delay = XMLHelper.get_value(hpxml, 'SoftwareInfo/extension/SimulationControl/AdvancedResearchFeatures/HVACBlowerOffDelay', :float)
